...
})({"khFAZ":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
scene("game", ({ level , score  })=>{
        ...
        return {
            update () {
                if (isBig) {
                    ...
                    timer -= dt();
                    if (timer <= 0) //if time <0 then we have to make mario small
                    this.smallify();
                }
            },
            isBig () {
    ...
    onUpdate(()=>{
        ...
        if (player.pos.y >= FALL_DEATH) go("lose", {
            score: scoreLabel.value
        });
    });
...
var ir = Object.defineProperty, Hi = Object.defineProperties;
...
, "vec3"), ue = class {
    ...
    static fromHSL(t, l, w) {
        ...
        let U = a((j, X, Y)=>(Y < 0 && (Y += 1), Y > 1 && (Y -= 1), Y < 1 / 6 ? j + (X - j) * 6 * Y : Y < 0.5 ? X : Y < 2 / 3 ? j + (X - j) * (2 / 3 - Y) * 6 : j)
        , "hue2rgb"), p = w < 0.5 ? w * (1 + l) : w + l - w * l, S = 2 * w - p, A = U(S, p, t + 1 / 3), q = U(S, p, t), V = U(S, p, t - 1 / 3);
...
a(E, "rgb");
var fr = a((i, t, l)=>v.fromHSL(i, t, l)
, "hsl2rgb"), k = class {
    constructor(t, l, w, U){
        b(this, "x", 0);
        b(this, "y", 0);
...
var R = class {
    ...
    mult(t) {
        let l = [];
        for(let w = 0; w < 4; w++)for(let U = 0; U < 4; U++)l[w * 4 + U] = this.m[0 + U] * t.m[w * 4 + 0] + this.m[4 + U] * t.m[w * 4 + 1] + this.m[8 + U] * t.m[w * 4 + 2] + this.m[12 + U] * t.m[w * 4 + 3];
        return new R(l);
    }
    multVec4(t) {
        return {
...
a(Kt, "wave");
var Zi = 1103515245, es = 12345, hr = 2147483648, be = class {
    constructor(t){
        b(this, "seed");
        this.seed = t;
    }
...
var Be = class {
    ...
    tick(t) {
        this.buf.push(1 / t), this.timer += t, this.timer >= 1 && (this.timer = 0, this.fps = Math.round(this.buf.reduce((l, w)=>l + w
...
var no = a((i = {
    ...
    let t = (()=>{
        ...
        let o = Ke(new ImageData(new Uint8ClampedArray([
            128,
            128,
            128,
            255,
    ...
    a(ve, "slice");
    function Ee(e, n) {
        return S(typeof n == "string" ? V(n).then((r)=>r.json()
        ).then((r)=>Ee(e, r)
        ) : J(null, e).then((r)=>{
            let u = {
            }, c = r.tex.width, s = r.tex.height;
            for(let o in n){
                let d = n[o], h = {
                    tex: r.tex,
    ...
    function Te(e, n, r = {
        ...
        let u = Ke(n, r), c = ve(r.sliceX || 1, r.sliceY || 1), s = {
            tex: u,
            frames: c,
            anims: r.anims || {
            }
    ...
    function J(e, n, r = {
        ...
        return S(new Promise((u, c)=>{
            ...
            typeof n == "string" ? j(n).then((s)=>u(Te(e, s, r))
            ).catch(c) : u(Te(e, n, r));
        }));
    }
    a(J, "loadSprite");
        ...
        return S(new Promise((u, c)=>{
            J(e, n).then((s)=>{
                V(r).then((o)=>o.json()
                    ...
                    for (let h1 of o.meta.frameTags)h1.from === h1.to ? s.anims[h1.name] = h1.from : s.anims[h1.name] = {
                        from: h1.from,
                        to: h1.to,
                        speed: 10,
                        loop: !0
    ...
    function Se(e, n, r, u = !1) {
        ...
        return a(c, "loadRawShader"), S(new Promise((s, o)=>{
            ...
            function d(h) {
                return h ? V(h).then((m)=>m.text()
                ).catch(o) : new Promise((m)=>m(null)
                );
            }
            if (a(d, "resolveUrl"), u) Promise.all([
                d(n),
                d(r)
            ]).then(([h, m])=>{
                s(c(e, h, m));
    ...
    function Ce(e, n) {
        return S(new Promise((r, u)=>{
            ...
            typeof n == "string" && V(n).then((c)=>c.arrayBuffer()
...
`) throw new Error(u);
    ...
    a(cn, "makeShader");
    function Nr(e, n, r, u) {
        let c = e.width / n, s = e.height / r, o = 1 / c, d = 1 / s, h = {
        }, m = u.split("").entries();
    ...
    function Tt(e, n, r, u = l.defTex, c = l.defShader, s = {
        ...
        for (let o1 of n)l.iqueue.push(o1 + l.vqueue.length / je - e.length);
    ...
    function pe(e) {
        ...
        re(), I(e.pos), Je(e.angle), ne(e.scale), I(c), Tt([
            ...
            2,
            3
        ], e.fixed, e.tex, e.shader, e.uniform), ie();
    }
    a(pe, "drawUVQuad");
    function Yr(e) {
        var s;
        ...
        if (e.tiled) {
            ...
            for(let g = 0; g < o; g++)for(let y = 0; y < d; y++)pe(D(P({
            }, e), {
        ...
        } else e.width && e.height ? (c.x = e.width / r, c.y = e.height / u) : e.width ? (c.x = e.width / r, c.y = c.x) : e.height && (c.y = e.height / u, c.x = c.y), pe(D(P({
        }, e), {
            scale: c.scale(e.scale || f(1)),
            tex: e.tex,
            quad: n,
    ...
    function Q(e) {
        ...
        if (e.width <= 0 || e.height <= 0) return;
        let n = e.width, r = e.height, c = Ye(e.origin || Ne).add(1, 1).scale(f(n, r).scale(-0.5)), s = [
            f(0, 0),
            f(n, 0),
            f(n, r),
            f(0, r)
    ...
    function We(e) {
        ...
        let u = e.width || 1, c = r.sub(n).unit().normal().scale(u * 0.5), s = [
            n.sub(c),
            n.add(c),
            r.add(c),
            r.sub(c)
        ...
        Tt(s, [
            ...
            2,
            3
        ], e.fixed, l.defTex, e.shader, e.uniform);
    }
    a(We, "drawLine");
    function dn(e) {
        let n = e.pts;
        ...
        if (!(n.length < 2)) {
            ...
            } else for(let r = 0; r < n.length - 1; r++)We(D(P({
            }, e), {
                p1: n[r],
                p2: n[r + 1]
            }));
    ...
    function pn(e) {
        ...
        e.radiusX === 0 || e.radiusY === 0 || Qe(D(P({
        }, e), {
...
` && (M.push(oe), y += m, oe === " " && (ee = M.length)), W = Math.max(W, y), te++;
    ...
    function En(e) {
        let n = new Map, r = {
            ...
            add (s) {
                ...
                let o = En(s);
                return o.parent = this, o.trigger("add"), Ue(()=>o.trigger("load")
                ), this.children.push(o), o;
            },
            readd (s) {
            ...
            update () {
                this.paused || (this.revery((s)=>s.update()
                ), this.trigger("update"));
            },
            draw () {
                this.hidden || (re(), I(this.pos), ne(this.scale), Je(this.angle), this.every((s)=>s.draw()
                ), this.trigger("draw"), ie());
            },
            use (s) {
                if (!s) return;
                ...
                for(let h2 in s)if (!ys.has(h2)) {
                    ...
                    this[h2] === void 0 && Object.defineProperty(this, h2, {
                        get: ()=>o[h2]
                        ,
                        set: (m)=>o[h2] = m
                        ,
                ...
                this.exists() ? (s.add && s.add.call(this), s.load && Ue(()=>s.load.call(this)
                ), d()) : s.require && o.cleanups.push(this.on("add", d));
            },
            unuse (s) {
                if (n.has(s)) {
                    let o = n.get(s);
            ...
            get (s) {
                return this.children.filter((o)=>s ? o.is(s) : !0
                ).sort((o, d)=>{
                    var g, y, x, W, O, M;
    ...
    function H(e, n) {
        if (Array.isArray(e)) {
            ...
            ;
        } else return typeof e == "function" ? p.on("input", ()=>Le() && e()
        ) : p.on("input", ()=>Le(e) && n()
        );
    }
    a(H, "onKeyPress");
    ...
    function Dt(e, n) {
        if (Array.isArray(e)) {
            ...
            ;
        } else return typeof e == "function" ? p.on("input", ()=>tt() && e()
        ) : p.on("input", ()=>tt(e) && n()
        );
    }
    a(Dt, "onKeyRelease");
    function Mn(e, n) {
        return typeof e == "function" ? p.on("input", ()=>Ze() && e(K())
        ) : p.on("input", ()=>Ze(e) && n(K())
        );
    }
    a(Mn, "onMouseDown");
    function At(e, n) {
        return typeof e == "function" ? p.on("input", ()=>Me() && e(K())
        ) : p.on("input", ()=>Me(e) && n(K())
        );
    }
    a(At, "onMousePress");
    function Ln(e, n) {
        return typeof e == "function" ? p.on("input", ()=>et() && e(K())
        ) : p.on("input", ()=>et(e) && n(K())
        );
    }
    a(Ln, "onMouseRelease");
                ...
                if (this.solid && ((o = this.area) == null ? void 0 : o.shape) === "rect") {
                    ...
                    p.root.every((h)=>{
                        ...
                        let y = {
                            p1: f(0),
                            p2: f(u, c)
                        }, x = 1, W = g.p1, O = f(g.p1.x, g.p2.y), M = g.p2, ee = f(g.p2.x, g.p1.y), te = 0, Ae = {
                            right: {
                                p1: W,
                                p2: O
                            },
    ...
    function di(e = {
        ...
        return typeof e == "number" ? (B("clean(time)", "cleanup({ delay: time })"), D(P({
        }, It({
            destroy: !0,
            delay: e
        })), {
    ...
    function fi(e = {
        ...
        return {
            ...
            _checkCollisions (c) {
                ...
                for(let s2 in n){
                    let o = n[s2];
                    this.isColliding(o) || delete n[s2];
                }
            },
            worldArea () {
                var m, g, y, x;
        ...
        return a(o, "trigger"), {
            ...
            enterState (d, ...h) {
                ...
                if (r) {
                    ...
                    let g = typeof r[m] == "string" ? [
                        r[m]
                    ] : r[m];
                    if (!g.includes(d)) throw new Error(`Cannot transition state from "${m}" to "${d}". Available transitions: ${g.map((y)=>`"${y}"`
                    ).join(", ")}`);
                }
    ...
    function Mi(e, ...n) {
        ...
        let r = p.on("updateStart", ()=>{
            ...
            }, p.defLayer = null, p.gravity = Vr, p.scenes[e](...n), i.debug !== !1 && In(), i.burp && Vn(), r();
        });
    }
    a(Mi, "go");
    function Li(e, n) {
    ...
    a(Yn, "explode");
    let $n = null, Xn = null;
    J(null, Lr).then((e)=>$n = e
    ), J(null, qr).then((e)=>Xn = e
    );
    function ki(e, n = {
    }) {
        var o, d;
        let r = (n.speed || 1) * 5, u = n.scale || 1, c = kt([
            it(e),
            Vt(Xn),
            st(0),
            Ft(),
    ...
    function Hn(e, n) {
        ...
        let u = me({
            ...
            color: E(255, 255, 255),
            fixed: !0
        }), c = u.width + r.x * 2, s = u.height + r.x * 2;
    ...
    function zn() {
        var e, n;
        if (C.inspect) {
            let r = null, u = v.fromArray((e = i.inspectColor) != null ? e : [
                0,
                0,
                255
            ]);
...
`),
    ...
    function Jn(e) {
        let n = a((r)=>{
            ...
            for(let s3 in t.mouseStates)t.mouseStates[s3] = kr(t.mouseStates[s3]);
...
},{}]},["khFAZ","g9e9u"], "g9e9u", "parcelRequire2971")
